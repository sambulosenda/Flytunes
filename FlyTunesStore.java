 ...
 * ------------------------
 * This program handles the data management for an on-line
 * music store where we manage an inventory of albums as well
 * as individual songs.
 */
...
public class FlyTunesStore extends ConsoleProgram {
	 ...
	 *  Note that this price update will also effect all albums
